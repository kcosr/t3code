...
| W0b | Recovery characterization — RESOLVED WITHOUT RUN: decision seams already covered; `onCreate` orchestration untestable pre-M6 (see `specs/kernel-milestones/w0b-recovery-characterization.md`); scenario map seeds M6's fixture matrix | W0a                            | closed                     |
