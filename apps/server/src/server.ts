...
import { historyHttpApiLayer, historyPrivacyBoundaryLayer } from "./history/http.ts";
...
import { voiceRealtimeControlRoutesLayer } from "./voice/realtimeControlHttp.ts";
import { voiceThreadTurnRoutesLayer } from "./voice/threadTurnHttp.ts";
...
const makeRoutesLayerBase = Layer.mergeAll(
  Layer.mergeAll(
    ...
    voiceRealtimeControlRoutesLayer,
    voiceThreadTurnRoutesLayer,
  ),
