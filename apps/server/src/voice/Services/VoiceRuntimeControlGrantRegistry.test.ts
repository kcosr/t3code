...
import { __testing } from "./VoiceRuntimeControlGrantRegistry.ts";

const persistence = VoiceRuntimeControlGrantRepositoryLive.pipe(
...
const run = <A, E>(
  effect: Effect.Effect<
    ...
    | import("../../persistence/Services/VoiceRuntimeControlGrants.ts").VoiceRuntimeControlGrantRepository
  >,
) =>
  Effect.gen(function* () {
